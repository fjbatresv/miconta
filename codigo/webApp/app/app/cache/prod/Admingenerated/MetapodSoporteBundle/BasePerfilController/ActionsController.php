...
$this->isGeneratedCsrfTokenValid($intention);
        ...
        return $this->render(
            'MetapodSoporteBundle:PerfilActions:index.html.twig',
            $this->getAdditionalRenderParameters($Perfil, 'delete') + array(
                ...
                "actionRoute" => "Metapod_SoporteBundle_Perfil_object",
    ...
    protected function executeObjectDelete(\Metapod\SoporteBundle\Model\Perfil $Perfil)
    {
        $Perfil->delete();
    }
     ...
     */
    protected function successObjectDelete(\Metapod\SoporteBundle\Model\Perfil $Perfil)
    {
        $this->get('session')->getFlashBag()->add(
            'success',
            $this->get('translator')->trans(
     ...
     * @return Response Must return a response!
     */
    protected function errorObjectDelete(\Exception $e, \Metapod\SoporteBundle\Model\Perfil $Perfil = null)
    {
        $this->get('session')->getFlashBag()->add(
            'error',
            $this->get('translator')->trans(
     ...
     * checking CSRF protection token or credentials.
     *
     * @param array $selected Selected \Metapod\SoporteBundle\Model\Perfil primary keys
     *
     * To customize your action look into:
...
$intention = 'Metapod_SoporteBundle_Perfil_batch';
$this->isGeneratedCsrfTokenValid($intention);
    ...
    {
        \Metapod\SoporteBundle\Model\PerfilQuery::create()
    ...
    protected function getObject($pk)
    {
        ...
        if (!$Perfil) {
            throw new \InvalidArgumentException("No Metapod\SoporteBundle\Model\Perfil found on Id : $pk");
        }
     ...
     */
    protected function getAdditionalRenderParameters(\Metapod\SoporteBundle\Model\Perfil $Perfil, $action)
    {
        return array();
    }
