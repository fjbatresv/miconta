...
$this->isGeneratedCsrfTokenValid($intention);
        ...
        return $this->render(
            'MetapodSoporteBundle:UsuarioActions:index.html.twig',
            $this->getAdditionalRenderParameters($Usuario, 'delete') + array(
                ...
                "actionRoute" => "Metapod_SoporteBundle_Usuario_object",
    ...
    protected function executeObjectDelete(\Metapod\SoporteBundle\Model\Usuario $Usuario)
    {
        $Usuario->delete();
    }
     ...
     */
    protected function successObjectDelete(\Metapod\SoporteBundle\Model\Usuario $Usuario)
    {
        $this->get('session')->getFlashBag()->add(
            'success',
            $this->get('translator')->trans(
     ...
     * @return Response Must return a response!
     */
    protected function errorObjectDelete(\Exception $e, \Metapod\SoporteBundle\Model\Usuario $Usuario = null)
    {
        $this->get('session')->getFlashBag()->add(
            'error',
            $this->get('translator')->trans(
     ...
     * checking CSRF protection token or credentials.
     *
     * @param array $selected Selected \Metapod\SoporteBundle\Model\Usuario primary keys
     *
     * To customize your action look into:
...
$intention = 'Metapod_SoporteBundle_Usuario_batch';
$this->isGeneratedCsrfTokenValid($intention);
    ...
    {
        \Metapod\SoporteBundle\Model\UsuarioQuery::create()
    ...
    protected function getObject($pk)
    {
        ...
        if (!$Usuario) {
            throw new \InvalidArgumentException("No Metapod\SoporteBundle\Model\Usuario found on Id : $pk");
        }
     ...
     */
    protected function getAdditionalRenderParameters(\Metapod\SoporteBundle\Model\Usuario $Usuario, $action)
    {
        return array();
    }
