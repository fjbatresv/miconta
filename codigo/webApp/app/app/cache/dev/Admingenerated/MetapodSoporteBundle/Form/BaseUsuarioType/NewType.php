...
class NewType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $formOptions = $this->getFormOption('EstadoUsuario', array(  'class' => 'Metapod\\SoporteBundle\\Model\\EstadoUsuario',  'multiple' => false,  'label' => 'Estado',  'translation_domain' => 'Admin',));
