...
use Metapod\SoporteBundle\Form\Type\Usuario\EditType;
...
class EditController extends BaseController
{
    ...
    {
        return $this->get('session')->get('Metapod\SoporteBundle\UsuarioEdit\Versions', array());
    }
    
        protected function setVersions($versions = array())
    {
        $this->get('session')->set('Metapod\SoporteBundle\UsuarioEdit\Versions', $versions);
    }
