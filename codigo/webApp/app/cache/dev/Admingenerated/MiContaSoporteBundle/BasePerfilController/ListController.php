...
use MiConta\SoporteBundle\Form\Type\Perfil\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('MiContaSoporteBundle:PerfilList:index.html.twig', $this->getAdditionalRenderParameters() + array(
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\PerfilList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\PerfilList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\PerfilList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\PerfilList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\PerfilList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('MiConta\SoporteBundle\PerfilList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('MiConta\SoporteBundle\PerfilList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\PerfilList\Sort');
        }
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\PerfilList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\PerfilList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('MiConta\SoporteBundle\PerfilList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\PerfilList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\PerfilList\Scopes', $this->getDefaultScopes());
    }
