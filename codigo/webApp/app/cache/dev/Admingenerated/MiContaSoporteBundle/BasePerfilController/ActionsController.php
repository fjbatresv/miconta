...
$this->isGeneratedCsrfTokenValid($intention);
        ...
        return $this->render(
            'MiContaSoporteBundle:PerfilActions:index.html.twig',
            $this->getAdditionalRenderParameters($Perfil, 'delete') + array(
                ...
                "actionRoute" => "MiConta_SoporteBundle_Perfil_object",
    ...
    protected function executeObjectDelete(\MiConta\SoporteBundle\Model\Perfil $Perfil)
    {
        $Perfil->delete();
    }
     ...
     */
    protected function successObjectDelete(\MiConta\SoporteBundle\Model\Perfil $Perfil)
    {
        $this->get('session')->getFlashBag()->add(
            'success',
            $this->get('translator')->trans(
     ...
     * @return Response Must return a response!
     */
    protected function errorObjectDelete(\Exception $e, \MiConta\SoporteBundle\Model\Perfil $Perfil = null)
    {
        $this->get('session')->getFlashBag()->add(
            'error',
            $this->get('translator')->trans(
     ...
     * checking CSRF protection token or credentials.
     *
     * @param array $selected Selected \MiConta\SoporteBundle\Model\Perfil primary keys
     *
     * To customize your action look into:
...
$intention = 'MiConta_SoporteBundle_Perfil_batch';
$this->isGeneratedCsrfTokenValid($intention);
    ...
    {
        \MiConta\SoporteBundle\Model\PerfilQuery::create()
    ...
    protected function getObject($pk)
    {
        ...
        if (!$Perfil) {
            throw new \InvalidArgumentException("No MiConta\SoporteBundle\Model\Perfil found on Id : $pk");
        }
     ...
     */
    protected function getAdditionalRenderParameters(\MiConta\SoporteBundle\Model\Perfil $Perfil, $action)
    {
        return array();
    }
