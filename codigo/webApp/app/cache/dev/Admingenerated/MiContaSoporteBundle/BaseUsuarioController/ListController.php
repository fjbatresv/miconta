...
use MiConta\SoporteBundle\Form\Type\Usuario\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('MiContaSoporteBundle:UsuarioList:index.html.twig', $this->getAdditionalRenderParameters() + array(
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\UsuarioList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\UsuarioList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\UsuarioList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\UsuarioList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\UsuarioList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('MiConta\SoporteBundle\UsuarioList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('MiConta\SoporteBundle\UsuarioList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\UsuarioList\Sort');
        }
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\UsuarioList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\UsuarioList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('MiConta\SoporteBundle\UsuarioList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('MiConta\SoporteBundle\UsuarioList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\UsuarioList\Scopes', $this->getDefaultScopes());
    }
