...
use MiConta\SoporteBundle\Form\Type\Usuario\EditType;
...
class EditController extends BaseController
{
    ...
    {
        return $this->get('session')->get('MiConta\SoporteBundle\UsuarioEdit\Versions', array());
    }
    
        protected function setVersions($versions = array())
    {
        $this->get('session')->set('MiConta\SoporteBundle\UsuarioEdit\Versions', $versions);
    }
