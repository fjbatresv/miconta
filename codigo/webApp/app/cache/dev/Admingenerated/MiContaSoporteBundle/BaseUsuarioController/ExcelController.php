...
class ExcelController extends ListController
{
    ...
    public function excelAction()
    {
      ...
      $response->headers->set('Content-Disposition', 'attachment;filename=admin_export_usarios.xlsx');
    ...
    protected function createExcelheader(\PhpExcel_Worksheet $sheet){
        ...
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(5, 1, "Username", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(5);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(6, 1, "Password", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(6);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(7, 1, "Direccion", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(7);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(8, 1, "Fecha nacimiento", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(8);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(9, 1, "Ultimo cambio password", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(9);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(10, 1, "Estado usuario id", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(10);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(11, 1, "Record password", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(11);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(12, 1, "Avatar", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(12);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(13, 1, "Conectado", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(13);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(14, 1, "Ultima ip", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(14);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(15, 1, "Empresa id", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(15);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(16, 1, "Created by", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(16);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(17, 1, "Updated by", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(17);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(18, 1, "Created at", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(18);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(19, 1, "Updated at", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(19);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                  }
    ...
    protected function createExcelData(\PhpExcel_Worksheet $sheet){
      ...
      foreach($results as $rowData){
          ...
          $sheet->setCellValueByColumnAndRow(17, $row, $data);
          ...
          $sheet->setCellValueByColumnAndRow(18, $row, $data);
          ...
          $sheet->setCellValueByColumnAndRow(19, $row, $data);
                          $row++;
      }
    }
