...
$this->isGeneratedCsrfTokenValid($intention);
        ...
        return $this->render(
            'MiContaSoporteBundle:UsuarioActions:index.html.twig',
            $this->getAdditionalRenderParameters($Usuario, 'delete') + array(
                ...
                "actionRoute" => "MiConta_SoporteBundle_Usuario_object",
    ...
    protected function executeObjectDelete(\MiConta\SoporteBundle\Model\Usuario $Usuario)
    {
        $Usuario->delete();
    }
     ...
     */
    protected function successObjectDelete(\MiConta\SoporteBundle\Model\Usuario $Usuario)
    {
        $this->get('session')->getFlashBag()->add(
            'success',
            $this->get('translator')->trans(
     ...
     * @return Response Must return a response!
     */
    protected function errorObjectDelete(\Exception $e, \MiConta\SoporteBundle\Model\Usuario $Usuario = null)
    {
        $this->get('session')->getFlashBag()->add(
            'error',
            $this->get('translator')->trans(
     ...
     * checking CSRF protection token or credentials.
     *
     * @param array $selected Selected \MiConta\SoporteBundle\Model\Usuario primary keys
     *
     * To customize your action look into:
...
$intention = 'MiConta_SoporteBundle_Usuario_batch';
$this->isGeneratedCsrfTokenValid($intention);
    ...
    {
        \MiConta\SoporteBundle\Model\UsuarioQuery::create()
    ...
    protected function getObject($pk)
    {
        ...
        if (!$Usuario) {
            throw new \InvalidArgumentException("No MiConta\SoporteBundle\Model\Usuario found on Id : $pk");
        }
     ...
     */
    protected function getAdditionalRenderParameters(\MiConta\SoporteBundle\Model\Usuario $Usuario, $action)
    {
        return array();
    }
