...
class FiltersType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $formOptions = $this->getFormOption('EstadoUsuario', array(  'class' => 'MiConta\\SoporteBundle\\Model\\EstadoUsuario',  'multiple' => false,  'required' => false,  'label' => 'Estado',  'translation_domain' => 'Admin',));
