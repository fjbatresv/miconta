...
use MiConta\SoporteBundle\Model\map\PerfilTableMap;
...
abstract class BasePerfilPeer
{
    ...
    const OM_CLASS = 'MiConta\\SoporteBundle\\Model\\Perfil';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MiConta\\SoporteBundle\\Model\\map\\PerfilTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePerfilPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MiConta\SoporteBundle\Model\map\PerfilTableMap());
      }
    }
