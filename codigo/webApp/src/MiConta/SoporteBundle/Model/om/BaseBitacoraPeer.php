...
use MiConta\SoporteBundle\Model\BitacoraPeer;
use MiConta\SoporteBundle\Model\UsuarioPeer;
use MiConta\SoporteBundle\Model\map\BitacoraTableMap;
...
abstract class BaseBitacoraPeer
{
    ...
    const OM_CLASS = 'MiConta\\SoporteBundle\\Model\\Bitacora';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MiConta\\SoporteBundle\\Model\\map\\BitacoraTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBitacoraPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MiConta\SoporteBundle\Model\map\BitacoraTableMap());
      }
    }
