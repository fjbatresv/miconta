...
abstract class BaseMenuPeer
{
    ...
    const OM_CLASS = 'MiConta\\SoporteBundle\\Model\\Menu';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MiConta\\SoporteBundle\\Model\\map\\MenuTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseMenuPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MiConta\SoporteBundle\Model\map\MenuTableMap());
      }
    }
