...
abstract class BaseMenuQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'MiConta\\SoporteBundle\\Model\\Menu';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MiConta\SoporteBundle\Model\PerfilMenuQuery A secondary query class using the current class as primary query
     */
    public function usePerfilMenuQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPerfilMenu($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PerfilMenu', '\MiConta\SoporteBundle\Model\PerfilMenuQuery');
    }
