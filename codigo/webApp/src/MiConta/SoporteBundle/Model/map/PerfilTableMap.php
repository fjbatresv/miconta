...
class PerfilTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.MiConta.SoporteBundle.Model.map.PerfilTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('MiConta\\SoporteBundle\\Model\\Perfil');
    ...
    {
        $this->addRelation('PerfilMenu', 'MiConta\\SoporteBundle\\Model\\PerfilMenu', RelationMap::ONE_TO_MANY, array('id' => 'perfil_id', ), 'CASCADE', null, 'PerfilMenus');
        $this->addRelation('UsuarioPerfil', 'MiConta\\SoporteBundle\\Model\\UsuarioPerfil', RelationMap::ONE_TO_MANY, array('id' => 'perfil_id', ), null, null, 'UsuarioPerfils');
    } // buildRelations()
