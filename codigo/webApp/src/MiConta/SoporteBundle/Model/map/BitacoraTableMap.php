...
class BitacoraTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.MiConta.SoporteBundle.Model.map.BitacoraTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('MiConta\\SoporteBundle\\Model\\Bitacora');
    ...
    {
        $this->addRelation('Usuario', 'MiConta\\SoporteBundle\\Model\\Usuario', RelationMap::MANY_TO_ONE, array('usuario_id' => 'id', ), null, null);
    } // buildRelations()
