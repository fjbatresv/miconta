...
class EstadoUsuarioTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.MiConta.SoporteBundle.Model.map.EstadoUsuarioTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('MiConta\\SoporteBundle\\Model\\EstadoUsuario');
    ...
    {
        $this->addRelation('Usuario', 'MiConta\\SoporteBundle\\Model\\Usuario', RelationMap::ONE_TO_MANY, array('id' => 'estado_usuario_id', ), null, null, 'Usuarios');
    } // buildRelations()
