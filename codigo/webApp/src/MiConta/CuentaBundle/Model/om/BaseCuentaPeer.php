...
use MiConta\CuentaBundle\Model\map\CuentaTableMap;
...
abstract class BaseCuentaPeer
{
    ...
    const OM_CLASS = 'MiConta\\CuentaBundle\\Model\\Cuenta';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MiConta\\CuentaBundle\\Model\\map\\CuentaTableMap';
    ...
    const CREATED_BY = 'cuenta.created_by';

    /** the column name for the updated_by field */
    const UPDATED_BY = 'cuenta.updated_by';

    /** the column name for the created_at field */
    const CREATED_AT = 'cuenta.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'cuenta.updated_at';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Cuenta objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nombre', 'Activo', 'CreatedBy', 'UpdatedBy', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'activo', 'createdBy', 'updatedBy', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (CuentaPeer::ID, CuentaPeer::NOMBRE, CuentaPeer::ACTIVO, CuentaPeer::CREATED_BY, CuentaPeer::UPDATED_BY, CuentaPeer::CREATED_AT, CuentaPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE', 'ACTIVO', 'CREATED_BY', 'UPDATED_BY', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'activo', 'created_by', 'updated_by', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nombre' => 1, 'Activo' => 2, 'CreatedBy' => 3, 'UpdatedBy' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'activo' => 2, 'createdBy' => 3, 'updatedBy' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        BasePeer::TYPE_COLNAME => array (CuentaPeer::ID => 0, CuentaPeer::NOMBRE => 1, CuentaPeer::ACTIVO => 2, CuentaPeer::CREATED_BY => 3, CuentaPeer::UPDATED_BY => 4, CuentaPeer::CREATED_AT => 5, CuentaPeer::UPDATED_AT => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE' => 1, 'ACTIVO' => 2, 'CREATED_BY' => 3, 'UPDATED_BY' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'activo' => 2, 'created_by' => 3, 'updated_by' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CuentaPeer::CREATED_BY);
            $criteria->addSelectColumn(CuentaPeer::UPDATED_BY);
            $criteria->addSelectColumn(CuentaPeer::CREATED_AT);
            $criteria->addSelectColumn(CuentaPeer::UPDATED_AT);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCuentaPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MiConta\CuentaBundle\Model\map\CuentaTableMap());
      }
    }
